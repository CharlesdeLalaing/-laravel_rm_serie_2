@if (Request::url() === 'http://127.0.0.1:8000/contact')
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-item active">
            <img src="{{ asset('img/animal1.jpg') }}" class="d-block w-50 m-auto" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{ asset('img/animal2.jpg') }}" class="d-block w-50 m-auto" alt="...">
        </div>
...
@elseif (Request::url() === 'http://127.0.0.1:8000/blog')
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
